...
# ===========================================================================
HOST = "amon"   # shown as  amon@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Engineering Student"),
    ("kv", "Research", "6G Space Communication"),
    ("kv", "Ambassador", "Threws Research World"),
    ("kv", "Lead", "IIC Internship Cell & Electronauts"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "C, C++, Python, JavaScript"),
    ("kv", "Frontend", "HTML, CSS, JS, React, Tailwind"),
    ("kv", "Backend", "Node.js"),
    ("kv", "Database", "MongoDB, MySQL"),
    ("kv", "AI/ML", "TensorFlow, PyTorch, LangChain"),
    ("kv", "Certs", "Google & Microsoft (AI/ML)"),
    ("kv", "Tools", "Git, GitHub, VS Code, MATLAB"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built AI-powered Healthcare Platform"),
    ("bul", "Developed Movie Recommendation System"),
    ("bul", "Offline AI"),
    ("bul", "Interested in AI, Web Dev, Research & Robotics"),
]
